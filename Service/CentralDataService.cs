    ...
    public class CentralDataService : ICentralDataService
    {
        ...
        public async Task UpdateCentral_DatasAsync(Central_Data central_data, int id)
        {
            ...
            if (dbCentral_Data != null)
            {
                ...
                dbCentral_Data.Doc2 = central_data.Doc2;
                dbCentral_Data.Doc3 = central_data.Doc3;
                dbCentral_Data.Doc4 = central_data.Doc4;
                dbCentral_Data.Doc5 = central_data.Doc5;
                dbCentral_Data.Doc6 = central_data.Doc6;
                dbCentral_Data.Doc7 = central_data.Doc7;
                await _context.SaveChangesAsync();
            }
        }
    }
